...
def read_langs(lang1, lang2, reverse=False):
    ...
    lines = open(osp.join(CURR_DIR, "data/%s-%s.txt" % (lang1, lang2)), encoding="utf-8").\
        read().strip().split('\n')
...
def train(
    ...
    for ei in range(input_length):
        encoder_outputs, encoder_hidden = encoder(input_variable[ei], encoder_hidden)
...
def showPlot(points):
    ...
    plt.plot(points)
    plt.savefig(osp.join(CURR_DIR, "data/encoder_decoder.png"), format="png")
